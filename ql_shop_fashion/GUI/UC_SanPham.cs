...
namespace GUI
{
    public partial class UC_SanPham : XtraUserControl
    {
        ...
        public UC_SanPham()
        {
            ...
            btn_luusp.Click += Btn_luusp_Click1;
        ...
        private void Btn_luusp_Click1(object sender, EventArgs e)
        {
        ...
        private void Btn_mochonanhsp_Click(object sender, EventArgs e)
        {
            using (OpenFileDialog ofd = new OpenFileDialog())
            {
                ...
                if (ofd.ShowDialog() == DialogResult.OK)
                {
                    ...
                    pb_anhsp.Image = Image.FromFile(ofd.FileName);
        ...
        public void themSP()
        {
            ...
            try
            {
                ...
                int maSanPham = int.TryParse(txt_masanpham.Text, out var tempMaSanPham) ? tempMaSanPham : 0;
